    ...
    public class PublicCommands : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task HelpCommand()
        {
            var builder = new EmbedBuilder()
                ...
                .AddField("Создание персонажа", $"Чтобы создать персонажа нужно написать команду !create и выбрать один из четырёх классов (Magic - Магия и алхимия, Faith - Вера, Japan - Японская армия, Melee - Орден тамплиеров). **Пример:**\n!create Magic")
